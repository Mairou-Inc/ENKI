$(document).ready(function () {
  $('.main-menu_burger').click(function (event) {
    $('.main-menu_burger, .main-menu_items').toggleClass('active');
    $('body').toggleClass('lock');
  });

  $('.main-menu_link').click(function (event) {
    $('.main-menu_items, .main-menu_burger').removeClass('active');
    $('body').removeClass('lock');
  });

  $('.clicker-item-progress-menu__1').click(function (event) {
    $('.item-progress-menu_elements__1').toggleClass('active');
  });
  $('.clicker-item-progress-menu__2').click(function (event) {
    $('.item-progress-menu_elements__2').toggleClass('active');
  });

  $('.clicker-item-progress-menu__3').click(function (event) {
    $('.item-progress-menu_elements__3').toggleClass('active');
  });

  $('.clicker-item-progress-menu__4').click(function (event) {
    $('.item-progress-menu_elements__4').toggleClass('active');
  });
  $('.clicker-item-progress-menu__5').click(function (event) {
    $('.item-progress-menu_elements__5').toggleClass('active');
  });


  $('.order-services_item__1').click(function (event) {
    $('.order-services_item__1').addClass('active');
    $('.order-services_item__2').removeClass('active');
    $('.order-services_item__3').removeClass('active');
    $('.order-services_item__4').removeClass('active');

  });
  $('.order-services_item__2').click(function (event) {
    $('.order-services_item__2').addClass('active');
    $('.order-services_item__1').removeClass('active');
    $('.order-services_item__3').removeClass('active');
    $('.order-services_item__4').removeClass('active');

  });

  $('.order-services_item__3').click(function (event) {
    $('.order-services_item__3').addClass('active');
    $('.order-services_item__1').removeClass('active');
    $('.order-services_item__2').removeClass('active');
    $('.order-services_item__4').removeClass('active');
  ...
  $('.order-services_item__4').click(function (event) {
    $('.order-services_item__4').addClass('active');
    $('.order-services_item__1').removeClass('active');
    $('.order-services_item__2').removeClass('active');
    $('.order-services_item__3').removeClass('active');
  ...
  $('.main-menu_link-projects').click(function (event) {
  ...
  $('.main-menu_link-services').click(function (event) {
  ...
  $('.main-menu_link-about').click(function (event) {
...
document.addEventListener('click', function (e) {
  if (!e.target.closest('.clicker-item-progress-menu__1')) {
    let user_menu = document.querySelector('.item-progress-menu_elements__1');
    user_menu.classList.remove('active');
  }
});
document.addEventListener('click', function (e) {
  if (!e.target.closest('.clicker-item-progress-menu__2')) {
    let user_menu = document.querySelector('.item-progress-menu_elements__2');
    user_menu.classList.remove('active');
  }
});

document.addEventListener('click', function (e) {
  if (!e.target.closest('.clicker-item-progress-menu__3')) {
    let user_menu = document.querySelector('.item-progress-menu_elements__3');
    user_menu.classList.remove('active');
  }
});

document.addEventListener('click', function (e) {
  if (!e.target.closest('.clicker-item-progress-menu__4')) {
    let user_menu = document.querySelector('.item-progress-menu_elements__4');
    user_menu.classList.remove('active');
  }
});

document.addEventListener('click', function (e) {
  if (!e.target.closest('.clicker-item-progress-menu__5')) {
    let user_menu = document.querySelector('.item-progress-menu_elements__5');
    user_menu.classList.remove('active');
  }
});
...
var sunrise_slider = new Swiper('.sunrise-slider_body', {
	/*
	effect: 'fade',
	autoplay: {
		  delay: 3000,
  ...
  // Arrows
  navigation: {
    nextEl: '.control-sunrise-slider_next',
    prevEl: '.control-sunrise-slider_prev'
  },
  breakpoints: {
    320: {
      autoHeight: true
...
var progress_slider = new Swiper('.progress-slider_body', {
	/*
	effect: 'fade',
	autoplay: {
		  delay: 3000,
  ...
  // Arrows
  navigation: {
    nextEl: '.control-progress-slider_next',
    prevEl: '.control-progress-slider_prev'
  },
  breakpoints: {
    320: {
      autoHeight: true
...
var projects_slider = new Swiper('.projects-slider_body', {
	/*
	effect: 'fade',
	autoplay: {
		  delay: 3000,
  ...
  // Arrows
  navigation: {
    nextEl: '.control-projects-slider_next',
    prevEl: '.control-projects-slider_prev'
  },
  // breakpoints: {
  //   320: {
  //     autoHeight: true
...
var team_slider = new Swiper('.team-slider_body', {
	/*
	effect: 'fade',
	autoplay: {
		  delay: 3000,
  ...
  // Arrows
  navigation: {
    nextEl: '.control-team-slider_next',
    prevEl: '.control-team-slider_prev'
  },
  // breakpoints: {
  //   320: {
  //     autoHeight: true
